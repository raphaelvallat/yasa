...
For more details on the output of the slow-waves detection, be sure to read the `sw_detect documentation <https://raphaelvallat.github.io/yasa/generated/yasa.sw_detect.html>`_ and try the `Jupyter notebooks <https://github.com/raphaelvallat/yasa/tree/master/notebooks>`_.
